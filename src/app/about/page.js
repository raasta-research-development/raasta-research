...
<div className="ml-64 relative flex items-center w-5/6 ">
  ...
  Planet Peep
          ...
          <li className="cursor-pointer hover:text-gray-500 border border-gray-300 rounded-md p-2 hover:bg-gray-50" onClick={() => setOption('option2')}>
Audio book</li>
          <li className="cursor-pointer hover:text-gray-500 border border-gray-300 rounded-md p-2 hover:bg-gray-50" onClick={() => setOption('option3')}>
  Articles & stories
</li>
        </ul>
      </nav>
...
<div className="mt-20 mb-20 items-center gap-20 flex mx-auto md:w-3/5 md:px-4">
  <h1 className="text-xl md:text-6xl leading-tight font-bold">Why Raasta?</h1>
